...
const Timetable = () => {
    return(<>
        ...
        <Box sx={{
            ...
            <Typography sx={{ marginTop: 2, fontWeight: 700 }}>Mon</Typography>
            <Typography sx={{ marginTop: 2, fontWeight: 700 }}>Tue</Typography>
            <Typography sx={{ marginTop: 2, fontWeight: 700 }}>Wed</Typography>
            <Typography sx={{ marginTop: 2, fontWeight: 700 }}>Thu</Typography>
            <Typography sx={{ marginTop: 2, fontWeight: 700 }}>Fri</Typography>
        </Box>
        {/* Timetable days */}
