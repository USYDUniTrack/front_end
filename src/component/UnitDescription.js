...
const UnitDescription = () => {
    return (<>
        <div className='UnitDescriptionWrapper'>
            ...
            <Typography sx={{fontSize: 15, fontWeight: 700}}>Semester 1</Typography>
            ...
            <Typography className='UnitDescriptionNotes' sx={{fontWeight: 700}}>Prohibitions: <span>COMP2129</span> or <span>COMP9017</span> or <span>COMP9129</span></Typography>
            <br />
        </div>
    </>)
}
